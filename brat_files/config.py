...
# Correct the syntax by using single or double quotes
ADMIN_CONTACT_EMAIL = 'admin@example.com'  # Use single quotes
# or
#ADMIN_CONTACT_EMAIL = "admin@example.com"  # Use double quotes
...
USER_PASSWORD = {
    'brat': 'brat',  # Default user; replace with secure credentials
    'user': 'user',
    # 'editor': 'annotate',  # Add more users as needed
}

# Advanced configurations can be added below as needed
